...
add_action( 'wp_enqueue_scripts', function () {
	wp_enqueue_style( 'bootstrap', '//netdna.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css', [ ], '3.3.4' );
	...
	wp_enqueue_script( 'bootstrap-js', '//netdna.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js', array( 'jquery' ), '3.3.4', true ); // all the bootstrap javascript goodness
